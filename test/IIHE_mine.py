...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:MC_MINIAOD.root')
...
na = TauIDEmbedder(process, cms,
    debug=True,
    toKeep = ["2016v1", "newDM2016v1","MVAele2016"]
)
na.runTauID()
...
process.IIHEAnalysis.eleMVATrigIdMap                             = cms.InputTag("egmGsfElectronIDs:mvaEleID-Spring15-25ns-Trig-V1-wp80")
process.IIHEAnalysis.eleMVAnonTrigIdMap                          = cms.InputTag("egmGsfElectronIDs:mvaEleID-Spring15-25ns-nonTrig-V1-wp80")
process.IIHEAnalysis.eleMVATrigwp90IdMap                         = cms.InputTag("egmGsfElectronIDs:mvaEleID-Spring15-25ns-Trig-V1-wp90")
process.IIHEAnalysis.eleMVAnonTrigwp90IdMap                      = cms.InputTag("egmGsfElectronIDs:mvaEleID-Spring15-25ns-nonTrig-V1-wp90")
process.IIHEAnalysis.eleMVAHZZwpLooseIdMap                       = cms.InputTag("egmGsfElectronIDs:mvaEleID-Spring16-HZZ-V1-wpLoose")
process.IIHEAnalysis.elemvaValuesMap_nonTrig                     = cms.InputTag("electronMVAValueMapProducer:ElectronMVAEstimatorRun2Spring15NonTrig25nsV1Values")
process.IIHEAnalysis.elemvaCategoriesMap_nonTrig                 = cms.InputTag("electronMVAValueMapProducer:ElectronMVAEstimatorRun2Spring15NonTrig25nsV1Categories")
process.IIHEAnalysis.elemvaValuesMap_Trig                        = cms.InputTag("electronMVAValueMapProducer:ElectronMVAEstimatorRun2Spring15Trig25nsV1Values")
process.IIHEAnalysis.elemvaCategoriesMap_Trig                    = cms.InputTag("electronMVAValueMapProducer:ElectronMVAEstimatorRun2Spring15Trig25nsV1Categories")
process.IIHEAnalysis.elemvaValuesMap_GP                          = cms.InputTag("electronMVAValueMapProducer:ElectronMVAEstimatorRun2Spring16GeneralPurposeV1Values")
process.IIHEAnalysis.elemvaCategoriesMap_GP                      = cms.InputTag("electronMVAValueMapProducer:ElectronMVAEstimatorRun2Spring16GeneralPurposeV1Categories")
process.IIHEAnalysis.elemvaValuesMap_HZZ                         = cms.InputTag("electronMVAValueMapProducer:ElectronMVAEstimatorRun2Spring16HZZV1Values")
process.IIHEAnalysis.elemvaCategoriesMap_HZZ                     = cms.InputTag("electronMVAValueMapProducer:ElectronMVAEstimatorRun2Spring16HZZV1Categories")
...
if (not fiducialStudy and not LHE):
