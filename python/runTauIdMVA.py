...
class TauIDEmbedder(object):
	...
	def runTauID(self, name='NewTauIDsEmbedded'):
		...
		# )
                ...
                if "MVAele2016" in self.toKeep:
                            self.process.rerunDiscriminationAgainstElectronMVA6 = patTauDiscriminationAgainstElectronMVA6.clone(
            		  PATTauProducer = self.cms.InputTag('slimmedTaus'),
                          Prediscriminants = noPrediscriminants,
			  #Prediscriminants = requireLeadTrack,
                          loadMVAfromDB = self.cms.bool(True),
                          returnMVA = self.cms.bool(True),
                          method = self.cms.string("BDTG"),
                          mvaName_NoEleMatch_woGwoGSF_BL = self.cms.string("RecoTauTag_antiElectronMVA6v1_gbr_NoEleMatch_woGwoGSF_BL"),
                          mvaName_NoEleMatch_wGwoGSF_BL = self.cms.string("RecoTauTag_antiElectronMVA6v1_gbr_NoEleMatch_wGwoGSF_BL"),
                          mvaName_woGwGSF_BL = self.cms.string("RecoTauTag_antiElectronMVA6v1_gbr_woGwGSF_BL"),
                          mvaName_wGwGSF_BL = self.cms.string("RecoTauTag_antiElectronMVA6v1_gbr_wGwGSF_BL"),
                          mvaName_NoEleMatch_woGwoGSF_EC = self.cms.string("RecoTauTag_antiElectronMVA6v1_gbr_NoEleMatch_woGwoGSF_EC"),
                          mvaName_NoEleMatch_wGwoGSF_EC = self.cms.string("RecoTauTag_antiElectronMVA6v1_gbr_NoEleMatch_wGwoGSF_EC"),
                          mvaName_woGwGSF_EC = self.cms.string("RecoTauTag_antiElectronMVA6v1_gbr_woGwGSF_EC"),
                          mvaName_wGwGSF_EC = self.cms.string("RecoTauTag_antiElectronMVA6v1_gbr_wGwGSF_EC"),
                          minMVANoEleMatchWOgWOgsfBL = self.cms.double(0.0),
                          minMVANoEleMatchWgWOgsfBL  = self.cms.double(0.0),
                          minMVAWOgWgsfBL            = self.cms.double(0.0),
                          minMVAWgWgsfBL             = self.cms.double(0.0),
                          minMVANoEleMatchWOgWOgsfEC = self.cms.double(0.0),
                          minMVANoEleMatchWgWOgsfEC  = self.cms.double(0.0),
                          minMVAWOgWgsfEC            = self.cms.double(0.0),
                          minMVAWgWgsfEC             = self.cms.double(0.0),
                          srcElectrons = self.cms.InputTag('slimmedElectrons'),
                          usePhiAtEcalEntranceExtrapolation = self.cms.bool(True)
                	)     
		tauIDSources.againstElectronMVA6RawNew = self.cms.InputTag('rerunDiscriminationAgainstElectronMVA6')
